...
class AppointmentsList extends StatelessWidget {
  ...
  Widget build(BuildContext inContext) {
    ...
    return ScopedModel<AppointmentsModel>(
        ...
        child: ScopedModelDescendant<AppointmentsModel>(builder: (inContext, inChild, inModel) {
          return Scaffold(
              // Add appointment.
                        ...
                        child: Padding(
                            ...
                            child: GestureDetector(
                              ...
                              Text(DateFormat.yMMMMd("en_US").format(inDate.toLocal()),
                                  ...
                                  style: TextStyle(
                                      color: Theme.of(inContext).accentColor, fontSize: 24)),
                              Divider(),
                              Expanded(
